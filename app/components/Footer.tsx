                ...
                <section className="py-8 sm:py-12 md:py-16 bg-white -mt-6 sm:-mt-8 md:-mt-10 -mb-16 sm:-mb-24 md:-mb-32 px-4 sm:px-6 lg:px-20">
                    <div className="max-w-6xl mx-auto">
                        <div className="rounded-xl sm:rounded-2xl px-4 py-4 sm:px-6 sm:py-5 md:px-8 md:py-6 lg:px-12 relative overflow-hidden group hover:shadow-2xl transition-all duration-500">
                            ...
                            <div className="relative text-black z-10 flex flex-col max-sm:items-stretch md:flex-row items-center justify-between gap-4 sm:gap-6 md:gap-8">
                                ...
                                <AnimatedEntrance {...ANIMATION_PRESETS.BUTTON_SCALE_UP} delay={400}>
                                    <Link href="/contact" className="flex-shrink-0 max-sm:w-full">
                                        <button className="bg-[#FF7700] text-white hover:bg-[#FF7700]/90 hover:scale-105 active:scale-95 px-4 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 rounded-lg transition-all duration-300 text-sm sm:text-base md:text-lg font-semibold shadow-lg hover:shadow-xl cursor-pointer max-sm:w-full">
                                            Contact Us
                                        </button>
                                    </Link>
                                </AnimatedEntrance>
                        ...
                        <AnimatedEntrance {...ANIMATION_PRESETS.CARD_FADE_UP} delay={STAGGER_DELAYS.MEDIUM[0]}>
                            <div className="sm:col-span-2 md:col-span-1">
                                <Link href="/" className="group cursor-pointer">
                                    <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center mb-4 sm:mb-6">
                                        <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-green-500 rounded-full flex items-center justify-center mb-3 sm:mb-0 sm:mr-4 transition-all duration-300 group-hover:scale-110 group-hover:rotate-6 group-hover:shadow-lg shrink-0">
                                            <Image
                                        ...
                                        <span className="text-base sm:text-lg md:text-xl font-bold flex-1 leading-tight transition-colors duration-300 group-hover:text-green-300">{MINISTRY_INFO.name}</span>
                                    </div>
                                </Link>
                                <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-3 sm:mb-4 md:mb-6 hover:text-gray-200 transition-colors duration-300">
                                    {MINISTRY_INFO.description}
                                </p>
                            </div>
                        </AnimatedEntrance>
                        ...
                        <AnimatedEntrance {...ANIMATION_PRESETS.CARD_FADE_UP} delay={STAGGER_DELAYS.MEDIUM[3]}>
                            <div>
                                ...
                                <div className="mt-4 sm:mt-6 space-y-1 sm:space-y-2 text-xs sm:text-sm text-gray-300">
                                    ...
                                    <a href="mailto:info@justice.im.gov" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">info@justice.im.gov</a>
